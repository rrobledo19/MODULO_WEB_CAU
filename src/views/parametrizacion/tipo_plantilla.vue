...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        { key: "id_plntlla", label: "#", sortable: true },
        { key: "id_tpo_prcso", label: "Tipo Proceso", sortable: true },
        { key: "desc_proceso", label: "Proceso", sortable: true },
        { key: "id_tpo_mdda", label: "id_tipo_medida", sortable: true },
        { key: "desc_mdda", label: "Medida", sortable: true },
        { key: "nmbre_plntlla", label: "Plantilla", sortable: true },
        { key: "tpo_plntlla", label: "Tipo_Plantilla", sortable: true },
      ...
      mensage_1 :"",
      titulo_general:"Registro Información Tipo Palntilla",
      manejador:"", 
  ...
  methods: {
    ...
    get_plantilla() {
      let url = "http://localhost:3000/tipo_plantilla/lista_plantilla";
      const v_plantilla = async () => {
        try {
        ...
        console.log("Respuestas del get", v_plantilla);
      };
